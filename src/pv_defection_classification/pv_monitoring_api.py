...
# RUN API DATA DRIFT ANALYSIS
@app.get("/run_drift_analysis",response_class = HTMLResponse)
async def run_drift_analysis():
    # Download training and drift data
    ...
    # Return HTML content
    with open('pv_defection_data_drift_report.html', 'r') as f:
        html_content = f.read()
